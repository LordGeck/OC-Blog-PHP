...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <div class="modal fade" id="postDelete" tabindex="-1" role="dialog" aria-labelledby="postDeleteLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <a class="btn btn-danger" href="index.php?action=deletePost&amp;id=<?= $blogPost['id'] ?>" role="button">Oui</a>
                        </div>
                    </div>
                </div>
            </div>
